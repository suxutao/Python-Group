...
channel.play(music_begin)
    ...
    # 字体和文本
start_font=pygame.font.SysFont('SimHei', 60)
...
score_font=pygame.font.SysFont('SimHei',50)
time_font = pygame.font.SysFont('SimHei', 50)
settle_font=pygame.font.SysFont('SimHei',60)
settle_font2=pygame.font.SysFont('SimHei',40)
choice_font=pygame.font.SysFont('SimHei',60)
